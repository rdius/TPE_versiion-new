 ...
 *  new
 *  Author: rdius
 *  Description: pollutants dispersion simulation  by applying an undirected wind.
 */
...
reflex wander when: intensity > 0
	{
...
//			}
	...
	reflex nextMove when: !(normalMove){
		//previousLoc <- copy(location);
...
experiment Air_Pollution_1 type: gui {
	output {
